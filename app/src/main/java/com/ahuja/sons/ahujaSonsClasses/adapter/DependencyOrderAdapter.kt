...
class DependencyOrderAdapter :
    ListAdapter<LocalWorkQueueData, DependencyOrderAdapter.OrderViewHolder>(OrderDiffCallback()) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderViewHolder {
        val binding =
            ItemDependecyOrderBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class OrderViewHolder(private val binding: ItemDependecyOrderBinding) :
        ...
        fun bind(order: LocalWorkQueueData) {
            binding.tvHospitalName.text = order.orderName
