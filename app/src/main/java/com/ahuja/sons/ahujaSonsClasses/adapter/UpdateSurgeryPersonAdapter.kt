...
class UpdateSurgeryPersonAdapter(private val context: Context, private var attachList: MutableList<SurgeryPersonNameListModel.Data>) : RecyclerView.Adapter<UpdateSurgeryPersonAdapter.ViewHolder>() { // private val customerList_gl: ArrayList<SpareItemListApiModel.DataXXX>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return UpdateSurgeryPersonAdapter.ViewHolder(binding)
    }
    ...
    fun addItem(item: SurgeryPersonNameListModel.Data) {
        attachList.add(item)
    ...
    fun getAttachList(): List<SurgeryPersonNameListModel.Data> {
