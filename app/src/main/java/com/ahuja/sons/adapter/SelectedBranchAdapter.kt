...
class SelectedBranchAdapter(private val context: Context, private val itemName : ArrayList<BranchAllListResponseModel.DataXXX>) : RecyclerView.Adapter<SelectedBranchAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvNameOfEmployee.setText("Branch - " + itemName[position].AddressName )
