...
class AddFOCPartsItemsAdapter(
    private val context: Context, private val attachList: MutableList<BodySparePart.SparePart>,
    private val customerList_gl: ArrayList<SpareItemListApiModel.DataXXX>
) : RecyclerView.Adapter<AddFOCPartsItemsAdapter.ViewHolder>() { // private val customerList_gl: ArrayList<SpareItemListApiModel.DataXXX>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return AddFOCPartsItemsAdapter.ViewHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            /*    acItemname.addTextChangedListener(object : TextWatcher {
