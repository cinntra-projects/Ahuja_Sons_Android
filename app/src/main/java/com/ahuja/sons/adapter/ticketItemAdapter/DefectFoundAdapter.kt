...
class DefectFoundAdapter (context: Context?, dataList: MutableList<ComplainDetailResponseModel.DataX>) : ArrayAdapter<String?>(context!!, R.layout.drop_down_item_textview) {
