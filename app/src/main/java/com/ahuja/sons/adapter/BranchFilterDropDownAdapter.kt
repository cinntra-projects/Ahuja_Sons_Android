...
class BranchFilterDropDownAdapter (private val context: Context, private val resourceId: Int, private val data: ArrayList<BranchAllListResponseModel.DataXXX>) : ArrayAdapter<BranchAllListResponseModel.DataXXX>(context, resourceId, data) {
