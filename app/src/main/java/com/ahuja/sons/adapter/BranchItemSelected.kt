...
class BranchItemSelected(private val context: Context, private val resourceId: Int, private val data: ArrayList<BranchAllListResponseModel.DataXXX>) : ArrayAdapter<BranchAllListResponseModel.DataXXX>(context, resourceId, data) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        name.setText("Item - " + model.AddressName )
