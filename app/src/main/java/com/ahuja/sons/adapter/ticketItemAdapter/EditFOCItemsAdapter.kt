...
class EditFOCItemsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding: SparePartsLayoutBinding =
            SparePartsLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return EditFOCItemsAdapter.ViewHolder(binding)
    }
...
//                    )
            ...
            acItemName.setSelection(
                Global.getItemSparePartyPos(customerList_gl, item.SparePartName)
            )
