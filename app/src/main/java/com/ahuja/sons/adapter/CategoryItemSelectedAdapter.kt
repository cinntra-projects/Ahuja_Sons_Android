...
class CategoryItemSelectedAdapter (private val context: Context, private val itemName : ArrayList<SolutionListResponseModel.DataXXX>) : RecyclerView.Adapter<CategoryItemSelectedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.tvNameOfEmployee.setText("Item - " + itemName[position].Title)
