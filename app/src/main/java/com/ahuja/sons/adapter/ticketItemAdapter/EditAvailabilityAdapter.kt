...
class EditAvailabilityAdapter(
    ...
    private val attachList: MutableList<SiteSurveyTicketResponse.Availability>
) : RecyclerView.Adapter<EditAvailabilityAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return EditAvailabilityAdapter.ViewHolder(binding)
    }
    ...
    fun addItem(item: SiteSurveyTicketResponse.Availability) {
        attachList.add(item)
    ...
    fun getAttachList(): List<SiteSurveyTicketResponse.Availability> {
