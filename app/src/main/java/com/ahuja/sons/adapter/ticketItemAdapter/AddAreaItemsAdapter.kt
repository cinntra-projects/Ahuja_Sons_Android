...
class AddAreaItemsAdapter(
    private val context: Context,
    private val attachList: MutableList<AreaCustomModel.Area>
) : RecyclerView.Adapter<AddAreaItemsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding: AddAreaItemAdapterLayoutBinding = AddAreaItemAdapterLayoutBinding.inflate(
            LayoutInflater.from(parent.context),
            parent,
            false
        )
        return AddAreaItemsAdapter.ViewHolder(binding)
    }
    ...
    fun addItem(item: AreaCustomModel.Area) {
        attachList.add(item)
    ...
    fun getAttachList(): List<AreaCustomModel.Area> {
